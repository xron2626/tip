...
function Search() {
  ...
  //  let domainUri = "https://port-0-java-springboot-17xqnr2algm9dni8.sel3.cloudtype.app";
    ...
    useEffect(() => {
        alert(window.location.href.split('keyword=')[1]);
    ...
    function connect(sessionId) {
      const socket = new WebSocket('https://siteproject22.online/api/my-websocket-endpoint');
      ...
      // ㅇㅇ..
      const socket2 = new WebSocket('https://siteproject22.online/api/my-websocket-endpoint2');
        ...
        <section id={condition ? styles.section : styles2.section}>
          <div className={condition ? styles.bodyHeader : styles2.bodyHeader}>
            <form action="/board/search" data-accept-charset="utf-8" method="get" id={condition ? styles.flex : styles2.flex} >
              ...
              <input type="text" name="keyword" value={keyword} id={condition ? styles.textarea : styles2.textarea} maxLength="255" onClick={searchScript} onChange={onChangeKeyword}/>
